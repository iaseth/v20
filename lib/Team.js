...
var Team = /*#__PURE__*/function (_BaseClass) {
  _inherits(Team, _BaseClass);

  var _super = _createSuper(Team);

  function Team(tournament, jo) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "getLink", function () {
      return "/teams/".concat(_this.path);
    });
    ...
    _this.name = jo.name;
    _this.abb = jo.abb;
    _this.path = jo.abb.toLowerCase();
    _this.color = jo.color;
    _this.fgStyle = {
      color: _this.color
    };
    _this.bgStyle = {
  ...
  _createClass(Team, [{
    ...
    value: function postBundleSetup() {
      var _iterator = _createForOfIteratorHelper(this.tournament.rivalries),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var rivalry = _step.value;
